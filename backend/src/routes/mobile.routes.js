...
router.post('/', authenticateToken, authorizeRoles(ROLES.SUPER_ADMIN), mobileController.createMobile);
...
router.post('/:id/images', authenticateToken, authorizeRoles(ROLES.SUPER_ADMIN), mobileImageController.addImage);
