...
apiClient.interceptors.response.use(
  ...
  (error) => {
    ...
    if (isNetworkError) {
      safeMessage = 'Unable to connect to Armaan Mobile Service Centre server. Please check your network connection.';
    } else if (status === 401) {
      ...
      safeMessage = 'Armaan Mobile Service Centre service is temporarily unavailable for maintenance. Please try again shortly.';
    }
