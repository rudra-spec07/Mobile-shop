        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-2.5 text-xs">
            ...
            <div className="flex items-center gap-2 text-slate-300">
              ...
              <span>support@ms-centre.shop</span>
            </div>
            <div className="flex items-center gap-2 text-slate-300">
            ...
            <div className="pt-2 flex items-center gap-2 text-slate-400">
              <a
                ...
                className="p-1.5 bg-slate-800 hover:bg-blue-600 hover:text-white rounded-lg transition-colors inline-flex items-center justify-center"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-1.5 bg-slate-800 hover:bg-pink-600 hover:text-white rounded-lg transition-colors inline-flex items-center justify-center"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-1.5 bg-slate-800 hover:bg-red-600 hover:text-white rounded-lg transition-colors inline-flex items-center justify-center"
