        ...
        <div className="bg-white rounded-3xl border border-slate-200/80 shadow-sm overflow-hidden">
          <div className="text-center bg-slate-50/80 p-6 sm:p-8 border-b border-slate-100">
            ...
            <h1 className="text-xl sm:text-2xl font-extrabold text-slate-900 tracking-tight">
              {isLogin ? 'Welcome Back to Armaan Mobile Service Centre' : 'Create Customer Account'}
            </h1>
            <p className="text-xs text-slate-500 mt-1.5 font-medium leading-relaxed">
              {isLogin
                ? 'Sign in to access your inquiries, service requests, and account'
                : 'Register to submit device requests and interact with Armaan Mobile Service Centre'}
            </p>
          </div>
